...
"""
A DAG to run MaxText determinism tests.
"""
import datetime
    ...
    for accelerator, slices in test_configs.items():
      ...
      for slice_num in slices:
        command = (
            ...
            f" determinism-{mode.value}-{slice_num}x-{accelerator}"
        ...
        maxtext_v4_configs_test = gke_config.get_gke_config(
            ...
            time_out_in_min=60,
            test_name=f"maxtext-determinism-{mode.value}",
