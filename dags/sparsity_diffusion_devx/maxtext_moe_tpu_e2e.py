...
with models.DAG(
  ...
  # Unchained tests
  # maxtext scripts: https://github.com/AI-Hypercomputer/maxtext/tree/main/tests/end_to_end/tpu
  test_models_tpu = {
      "deepseek32-671b": {
      ...
      "qwen3.5-35b-a3b": {
          "script_name": "tpu/qwen/moe/qwen3.5-35b-a3b/2_test_qwen3.5_35b_a3b",
          "cluster": XpkClusters.TPU_V5P_128_CLUSTER,
          "time_out_in_min": 90,
