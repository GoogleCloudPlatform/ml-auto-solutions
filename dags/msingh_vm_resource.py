...
V5_NETWORKS_PREFIX_ONE = "projects/tpu-prod-env-one-vm"
V5_NETWORKS_ONE = "projects/tpu-prod-env-one-vm/global/networks/msingh-mas-test"
V5E_SUBNETWORKS_ONE = "projects/tpu-prod-env-one-vm/regions/us-east1/subnetworks/msingh-mas-us-east-1"
