...
def trigger_agent_on_failure(context):
    """Airflow on_failure_callback that triggers the Cloud Run Agent via Python SDK."""
    try:
        ...
        print(f"Successfully triggered Cloud Run Job. Operation: {operation.operation.name}")
