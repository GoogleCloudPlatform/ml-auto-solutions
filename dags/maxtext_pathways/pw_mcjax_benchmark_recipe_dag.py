...
from xlml.utils.xpk import _get_core_api_client, _list_workload_pods, _get_batch_api_client, _get_workload_job, LOGGING_URL_FORMAT
...
with DAG(
  ...
  def run_workload(recipe_cmds):
    ...
    container_workload_cmds = ENV_COMMAND[0] + ' && ' + recipe_cmds[0]

    with tempfile.TemporaryDirectory() as tmpdir:
      xpk_cmds = [
        "set -xue",
        "git clone --branch v0.4.1 https://github.com/AI-Hypercomputer/xpk"
        f" {tmpdir}/xpk",
