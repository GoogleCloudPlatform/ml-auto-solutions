  ...
  PyTorchTpuVmMixin:: experimental.PyTorchTpuVmMixin + experimental.PjRt {
    ...
    tpuSettings+: {
      ...
      tpuVmPytorchSetup: |||
        ...
        pip install https://storage.googleapis.com/pytorch-xla-releases/wheels/tpuvm/torch_xla-2.4.0rc1-cp310-cp310-linux_x86_64.whl
        pip install torch_xla[tpu] -f https://storage.googleapis.com/libtpu-releases/index.html
        pip install pillow
        git clone --depth=1 https://github.com/pytorch/pytorch.git
        cd pytorch
        git clone -b v2.4.0-rc1 https://github.com/pytorch/xla.git
      |||,
    },
    podTemplate+:: {
      spec+: {
  ...
  GpuMixin:: {
    ...
    entrypoint: [
      ...
      |||
        ...
        mkdir -p pytorch/xla
        git clone -b v2.4.0-rc1 https://github.com/pytorch/xla.git pytorch/xla
