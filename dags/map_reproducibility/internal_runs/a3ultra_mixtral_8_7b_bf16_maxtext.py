...
def run_aotc_workload():
  with tempfile.TemporaryDirectory() as tmpdir:
    ...
    full_config_yaml_path = "/home/airflow/gcs/dags/dags/map_reproducibility/recipes/a3ultra/mixtral-8x7b-256gpus-a3u-bf16.yaml"
    ...
    result = hook.run_command(
        [
            ...
            ";".join(
                ...
                + install_helm_cmds()
                + namespace_cmds()
                + get_internal_pre_workload_cmds(MODEL_ID, FRAMEWORK)
...
with models.DAG(
    dag_id=f"internal_{HYPERCOMPUTER}_recipes_{MODEL_ID}_{FRAMEWORK}",
