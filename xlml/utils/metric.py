...
def get_gcs_profile_locations(dir_location: str) -> str:
  """
  Find the first gcs locations matching regex {dir_location}/.*/*xplane.pb

  Example:
    input dir_location = "gs://runner-maxtext-logs/run_name/tensorboard/plugins/profile"
    matched file_location = "gs://runner-maxtext-logs/run_name/tensorboard/plugins/profile/2025_05_16_18_02_41/gke-tpu-bd2459aa-wk1f.xplane.pb"
...
def download_profile(
  ...
  Download profile from file_location to tmp_location = f"{tmp_dir}/gke.xplane.pb"
...
def xplane_to_metrics(input_dir: str) -> dict:
  ...
  Remove temporory input_dir generated by `download_profile` which starts with "/tmp/profile-"
